...
class AppEffects extends InheritedWidget {
  const AppEffects({super.key, required this.reduceVisualEffects, required super.child});

  final bool reduceVisualEffects;

  /// Whether glass should render as its opaque fallback here.
  static bool reduced(BuildContext context) =>
      context.dependOnInheritedWidgetOfExactType<AppEffects>()?.reduceVisualEffects ?? false;
