...
String shortcutLabel(AppLocalizations l10n, AppShortcut shortcut) => switch (shortcut.id) {
...
String shortcutPaneLabel(AppLocalizations l10n, ShortcutScreen screen, ShortcutPane pane) =>
    switch ((screen, pane)) {
