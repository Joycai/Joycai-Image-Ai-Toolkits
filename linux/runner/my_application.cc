...
static void my_application_activate(GApplication* application) {
  ...
  if (use_header_bar) {
    ...
    gtk_header_bar_set_title(header_bar, "Joycai Image AI Toolkits");
    gtk_header_bar_set_show_close_button(header_bar, TRUE);
    gtk_window_set_titlebar(window, GTK_WIDGET(header_bar));
  } else {
    gtk_window_set_title(window, "Joycai Image AI Toolkits");
  }
  ...
  if (exe_path != nullptr) {
    ...
    g_autofree gchar* icon_path = g_build_filename(dir, "data", "flutter_assets", "assets", "icon", "icon.png", nullptr);
