...
void main() {
  final jpeg = Uint8List.fromList([0xFF, 0xD8, 0xFF, 0xE0, 0, 0x10, 0x4A, 0x46, 0x49, 0x46, 0, 1]);
  ...
  test('unrecognised bytes keep the declared type', () {
    ...
    expect(imageDataUrl(unknown, 'image/heic'), startsWith('data:image/heic;base64,'));
  });
}
