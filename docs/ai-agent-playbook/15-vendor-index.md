...
| **xAI Grok** | ②（官方推荐；① 已标弃用）；Grok Imagine 出图 / 视频 | 01 §9.1；03 §7.1、§7.3；05 §5「② Responses 族」、§7（tool search 403）；13 §4.2「xai-images」；14 §2；坑 66–67 | 【实测 2026-09】 |
...
| **字节跳动火山方舟（豆包 / Seedream）** | ① chat；Seedream 出图（`ark` route，含流式与拆图层）；按量 / 套餐两个 base；另有 openspeech 的录音识别极速版（独立鉴权头） | 01 §9.3；03 §3.2（对话思考控制）；13 §4.1（含「流式出图」「拆图层的实测形状」）、§8；14 §2（Seedance 套餐 404）；16 §10.2（ASR，【实现】）；坑 79–85、87、114、122 | 【实测 2026-09-18】 |
