...
| **xAI Grok** | ②（官方推荐；① 已标弃用）；Grok Imagine 出图（2.0：`quality` low/medium、`resolution` 1k/1.5k/2k、`usage.cost_in_usd_ticks` 报实扣；初代平价）/ 视频 | 01 §9.1；03 §7.1、§7.3；05 §5「② Responses 族」、§7（tool search 403）；13 §4.2「xai-images」（质量 / 分辨率 / 定价端点 / 参考图上限纠错）、§7（报价、输入图按张）；06 §1（第四种口径）；14 §2；坑 66–67、123–128 | 【实测 2026-09-22 出图质量与计费；其余 2026-09】 |
